    ...
    return (
        <main>
            <div className="heading">
                <h1>Stefano Radice</h1>
                <h2>Web Developer</h2>
                <a href="https://stefanoradice.com/" title="Stefano Radice website" target="_blank">stefanoradice.com</a>
                <div className="contacts">
                    <a href="mailto:info@stefanoradice.com" className="btn">
                    ...
                    <a href="https://www.linkedin.com/in/radicestefano/" target="_blank" className="btn btn--blue"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
